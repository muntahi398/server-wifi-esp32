...
void tcp_server(void *pvParam){
  ...
  //https://stackoverflow.com/questions/24194961/how-do-i-use-setsockoptso-reuseaddr/25193462
        ...
        while(1){
            ...
            write(cs , "Hello, congrats, server is on, send data \n <" , 41); //strlen(recv_buf) 
            //write(cs , "Hello, congrats, server is on, send data /n <" , 41);

            //fcntl(cs,F_SETFL,O_NONBLOCK);
            do {
                bzero(recv_buf, sizeof(recv_buf));  //write zero-valued bytes
